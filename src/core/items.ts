...
defItem({ id: ITEM.FLINT, name: 'Flint', maxStack: 64, icon: TILE.ITEM_FLINT });
defItem({ id: ITEM.FLINT_AND_STEEL, name: 'Flint and Steel', maxStack: 1, icon: TILE.ITEM_FLINT_STEEL });
...
/** Curated creative-palette catalogue (blocks first, then tools/food/misc). */
export const CREATIVE_ITEMS: ReadonlyArray<number> = [
  B.STONE, B.COBBLESTONE, B.STONE_BRICKS, B.CRACKED_STONE_BRICKS, B.CHISELED_STONE_BRICKS,
  B.GRANITE, B.DIORITE, B.ANDESITE, B.DIRT, B.GRASS, B.SAND, B.GRAVEL, B.SANDSTONE,
  B.OAK_LOG, B.OAK_PLANKS, B.BIRCH_LOG, B.BIRCH_PLANKS, B.OAK_LEAVES, B.BIRCH_LEAVES,
  B.CHERRY_LOG, B.CHERRY_PLANKS, B.CHERRY_LEAVES, B.JUNGLE_LOG, B.JUNGLE_PLANKS, B.JUNGLE_LEAVES,
  B.SPRUCE_LOG, B.SPRUCE_PLANKS, B.SPRUCE_LEAVES, B.SWAMP_GRASS, B.ICE, B.SNOW_BLOCK, B.LILY_PAD,
  B.GLASS, B.WOOL, B.GLOWSTONE, B.OBSIDIAN, B.BEDROCK,
  B.TORCH, B.CRAFTING_TABLE, B.FURNACE_N, B.CHEST_N, B.HOPPER, B.BED, B.ENCHANTING_TABLE,
  B.TALL_GRASS, B.FLOWER_RED, B.FLOWER_YELLOW, B.CACTUS,
  B.COAL_ORE, B.IRON_ORE, B.GOLD_ORE, B.REDSTONE_ORE, B.DIAMOND_ORE,
  B.IRON_BLOCK, B.GOLD_BLOCK, B.DIAMOND_BLOCK, B.COAL_BLOCK, B.REDSTONE_BLOCK,
  B.LEVER, B.PRESSURE_PLATE, B.REDSTONE_LAMP, B.PISTON_N, B.TRAPDOOR,
  B.NETHERRACK, B.SOUL_SAND, B.MAGMA,
  ITEM.REDSTONE, ITEM.DOOR, ITEM.STICK, ITEM.COAL, ITEM.IRON_INGOT, ITEM.GOLD_INGOT,
  ITEM.DIAMOND, ITEM.FLINT, ITEM.FLINT_AND_STEEL, ITEM.BUCKET, ITEM.WATER_BUCKET,
  ITEM.LAVA_BUCKET, ITEM.BOAT, ITEM.ARROW,
  ITEM.DIAMOND_PICKAXE, ITEM.DIAMOND_AXE, ITEM.DIAMOND_SHOVEL, ITEM.DIAMOND_SWORD,
  ITEM.COOKED_BEEF, ITEM.COOKED_PORKCHOP, ITEM.COOKED_CHICKEN, ITEM.COOKED_MUTTON,
